...
class Credit extends Model
{
    ...
    {
        $query = "SELECT SUM(amount) AS total FROM credit WHERE factory_id = :factory_id AND status = 'receivable'";
    ...
    {
        $query = "SELECT SUM(amount) AS total FROM credit WHERE factory_id = :factory_id AND status = 'received'";
        $arr['factory_id'] = $_SESSION['USER']->factory_id;
