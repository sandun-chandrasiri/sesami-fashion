...
<div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px;">
    ...
    <div class="card-group justify-content-center">
        <form method="post">
            ...
            <div class="mb-3">
                <input autofocus class="form-control" value="<?=get_var('order_name')?>" type="text" name="order_name" placeholder="Order Name">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input autofocus class="form-control" value="<?=get_var('customer_name')?>" type="text" name="customer_name" placeholder="Customer Name">
            </div>
            <div class="mb-3">
                <input autofocus class="form-control" value="<?=get_var('address_line_one')?>" type="text" name="address_line_one" placeholder="Address Line One">
            </div>
            <div class="mb-3">
                <input autofocus class="form-control" value="<?=get_var('address_line_two')?>" type="text" name="address_line_two" placeholder="Address Line Two">
            </div>
            <div class="mb-3">
                <input autofocus class="form-control" value="<?=get_var('contact')?>" type="text" name="contact" placeholder="Contact number">
            </div>
            <div class="mb-3">
                <input autofocus class="form-control" value="<?=get_var('email')?>" type="text" name="email" placeholder="Email">
            </div>
            <div class="mb-3">
                <select class="my-2 form-control" name="payment_type">
                    <option <?=get_select('payment_type','')?> value="">--Select a Payment Type--</option>
            ...
            <div class="mb-3">
                <input autofocus class="form-control" value="<?=get_var('quantity')?>" type="text" name="quantity" placeholder="Quantity">
            </div>
            <div class="mb-3">
                <input autofocus class="form-control" value="<?=get_var('total')?>" type="text" name="total" placeholder="Total">
            </div>
