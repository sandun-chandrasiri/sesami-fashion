...
<?php $this->view('includes/nav')?>
	...
	<div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px;">
		...
		<div class="card-group justify-content-center">
			 ...
			 <form method="post">
			 	<h3>Edit Product Details</h3><br><br>
				...
				<?php endif;?>
			 	...
			 	<div class="mb-3">
	                <input autofocus class="form-control" value="<?=get_var('product',$row[0]->product)?>" type="text" name="product" placeholder="Product Name">
	            </div>
	            <div class="mb-3">
	                <input class="form-control" value="<?=get_var('description',$row[0]->description)?>" type="text" name="description" placeholder="Description">
	            </div>
	            <div class="mb-3">
	                <input class="form-control" value="<?=get_var('bom',$row[0]->bom)?>" type="text" name="bom" placeholder="Bill of Material">
	            </div>
	            <div class="mb-3">
