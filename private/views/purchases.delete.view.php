	...
	<div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px;">
		...
		<div class="card-group justify-content-center">
			 ...
			 <form method="post">
			 	...
			 	<input disabled autofocus class="form-control" value="<?=get_var('purchase_name',$row[0]->purchase_name)?>" type="text" name="purchase_name" placeholder="Purchase Order Name"><br><br>
