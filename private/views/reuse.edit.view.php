...
<?php $this->view('includes/nav')?>
	...
	<div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px;">
		...
		<div class="card-group justify-content-center">
			 ...
			 <form method="post">
			 	<h3>Edit Reuse Details</h3><br><br>
				...
				<?php endif;?>
			 	...
			 	<div class="mb-3">
                	<input autofocus class="form-control" value="<?=get_var('reuse',$row[0]->reuse)?>" type="text" name="reuse" placeholder="Reuse">
	            </div>
	            <div class="mb-3">
		...
		<?php else: ?>
			...
			<div style="text-align: center;">
				<h3>That Reuse record was not found!</h3>
