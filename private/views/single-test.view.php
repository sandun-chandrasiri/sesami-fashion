				...
				<tr>
					...
					<td>
						<a href="<?=ROOT?>/single_team/<?=$row->team_id?>?tab=tests">
							<button class="btn btn-sm btn-primary"><i class="fa fa-chevron-right"></i>View team</button>
						</a>

						<a href="<?=ROOT?>/single_test/<?=$row->test_id?>?tab=scores">
							<button class="btn btn-sm btn-primary"><i class="fa fa-chevron-right"></i>Quality Status</button>
						</a>
