...
<div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px;">
    ...
    <div class="card-group justify-content-center">
        <form method="post">
            ...
            <div class="mb-3">
                <input autofocus class="form-control" value="<?=get_var('supplier')?>" type="text" name="supplier" placeholder="Supplier Name">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input class="form-control" value="<?=get_var('rating')?>" type="text" name="rating" placeholder="Rating">
            </div>
