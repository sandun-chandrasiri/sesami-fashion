...
<div class="container-fluid text-center">
	<div class="text-danger"><?=$percentage?>% Checked</div>
	...
	<?php if($answered_test_row):?>
		...
		<?php else:?>
			<div class="text-danger">
				This Quality Check has not yet been submitted<br>
				<a onclick="submit_test(event)" href="<?=ROOT?>/take_test/<?=$row->test_id?>/?submit=true">
					<button class="btn btn-danger float-end">Submit Quality Check</button>
				</a>
			</div>
		<?php endif;?>
