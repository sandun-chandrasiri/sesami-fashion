<form method="post" class="form mx-auto" style="width:100%;max-width: 400px;">
	...
	<input value="<?=get_var('name')?>" autofocus class="form-control" type="text" name="name" placeholder="Manager Name">
	<br>
	<a href="<?=ROOT?>/single_team/<?=$row->team_id?>?tab=managers">
