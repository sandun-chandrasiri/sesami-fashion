 		...
 		<?php if(isset($test_row) && is_object($test_row)):?>
			 ...
			 <form method="post">
				...
				<?php endif;?>
			 	...
			 	<textarea name="description" class="form-control" placeholder="Add a description for this Quality Check"><?=get_var('description',$test_row->description)?></textarea>
