<div class="card-group justify-content-center">
	...
	<table class="table table-striped table-hover">
		<tr><th></th><th>Team Name</th><th>Created by</th><th>Date</th>
			<th>
		...
		<?php if(isset($rows) && $rows):?>
			...
			<?php foreach ($rows as $row):?>
			 ...
			 <tr>
			 	...
			 	<td><?=$row->team?></td><td><?=$row->user->firstname?> <?=$row->user->lastname?></td><td><?=get_date($row->date)?></td>
 			...
 			<?php endforeach;?>
			<?php else:?>
				<tr><td colspan="5"><center>No teams were found at this time</center></td></tr>
			<?php endif;?>
