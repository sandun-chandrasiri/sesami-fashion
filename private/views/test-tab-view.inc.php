		    ...
		    <p class="card-text"><?=esc($question->comment)?></p>
			  ...
			  ?>
		    	...
		    	<?php if($question->question_type == 'objective'):
		    		$type = '?type=objective';
		    	?>
		    	<p class="card-text"><b>Team Leader's Input:</b> <?=esc($question->correct_answer)?></p>
		    	<?php endif;?>
