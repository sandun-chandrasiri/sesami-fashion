...
<div class="table-responsive container-fluid p-0" >
	<table class="table table-striped table-hover">
		<tr><th></th><th>Quality Check</th><th>Created by</th><th>Active</th><th>Date</th>
			<th>Checked</th>
			<th></th>
		</tr>
		<?php if(isset($test_rows) && $test_rows):?>
			...
			<?php foreach ($test_rows as $test_row):?>
			 ...
			 <tr style="<?=(in_array($test_row->test_id, $unsubmitted)) ? 'background-color:#eebebe':''?>" >
				...
				<td>
			 		...
			 		<a href="<?=ROOT?>/take_test/<?=$test_row->test_id?>">
			 		 <button class="btn btn-sm btn-primary">Open Quality Check</button>
			 		</a>
			 		<?php endif;?>
 			...
 			<?php endforeach;?>
			<?php else:?>
				<tr><td colspan="10"><center>No Quality Checks were found at this time</center></td></tr>
			<?php endif;?>
